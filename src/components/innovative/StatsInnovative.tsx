...
const stats = [
  {
    ...
    description: 'This represents the total amount of assets secured within our DeFi protocols, showcasing our platform’s reliability and trust.',
  ...
  },
  {
    ...
    suffix: '+',
    label: 'Active Users',
    description: 'A growing community of users who trust our platform for their decentralized finance needs.',
  ...
  },
  {
    ...
    description: 'We support multiple DeFi protocols, allowing users to diversify their investments and maximize returns.',
  ...
  },
  {
    ...
    description: 'Our platform has received top ratings from leading auditors for its security measures and protocols.',
    gradient: 'from-red-500 to-orange-500'
  }
];

export function StatsInnovative() {
  return (
